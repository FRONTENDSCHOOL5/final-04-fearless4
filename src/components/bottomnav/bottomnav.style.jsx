...
export function BottomNavContainer(props) {
  ...
  return (
    <BottomNav>
      <NavLink to='/homeFeed'>
        <NavIcon id="home" src={isHomeMouseOver ? homeIconFill : props.home === true ? homeIconFill : homeIcon} onMouseOver={handleMouseOver} onMouseOut={handleMouseOut} />
        <span className='nav-text'>홈</span>
      </NavLink>
      <NavLink href='#'>
        <NavIcon id="message" src={isMessageMouseOver? messageIconFill: props.message === true ? messageIconFill : messageIcon} onMouseOver={handleMouseOver} onMouseOut={handleMouseOut} />
        <span className='nav-text'>채팅</span>
      </NavLink>
      <NavLink to='/writePost'>
        <NavIcon id="post" src={isPostMouseOver ? postIconFill : props.post === true ? postIconFill : postIcon} onMouseOver={handleMouseOver} onMouseOut={handleMouseOut} />
        <span className='nav-text'>게시물 작성</span>
      </NavLink>
      <NavLink to='/myProfile'>
        <NavIcon id='profile' src={isProfileMouseOver ? profileIconFill : profileIcon} onMouseOver={handleMouseOver} onMouseOut={handleMouseOut} />
